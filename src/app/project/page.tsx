    ...
    <div>
      ...
      <div className="pro1">
        <div className="ii">
          ...
          <div className="par1">
          In this project, I have developed a user-friendly contact form using HTML and CSS. The form is designed to facilitate communication between users and the website by collecting essential information such as the user's name, email address, and a message.
          </div>
        </div>
        <div className="I1">
